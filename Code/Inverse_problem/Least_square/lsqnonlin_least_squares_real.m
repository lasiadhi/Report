%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lsqnonlin: trust-region-reflective method for real data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc
clear 
close all
...
[h_hat,resnorm2] = lsqnonlin(@objective_real_new, h_guess+1e-5, zeros(N,1),repmat(12,[N,1]),options);
resnorm2;
...
% plot(xq,h_hat3, '-^r');
plot(xq,h_approx, '-r');
title('lsqnonlin Method with Real Data', 'fontSize',14);
xlim([0,1150])
