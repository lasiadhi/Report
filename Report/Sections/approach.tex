...
Here we perform a preliminary study on potential inversion schemes. We use various inversion schemes to recover an unknown bathymetry using a mock forward model and manufactured data. This preliminary work aided in the selection process of the three inverse methods chosen for this project. %\subsection{The Additive Gaussian Noise Model} \label{Gaussian_noise}
