...
\caption{Verification that the Metropolis algorithm has been properly implemented in our code. We test a simple ODE problem. The red line represents the known value of the parameter $\alpha$. The blue curve is the posterior probabilty distribution sampled by our algorithm. The posterior we compute accurately estimates the true value of $\alpha$.}
\label{mcmc-real}
\end{figure}
