...
Although there have been uncertainties in capturing the topography of the ocean near shore, mathematical methods could estimate bathymetry using the dispersion relationship between wavelength and the period. \citet{stockdon2000} used video imagery, which compared true wave signal and remotely sensed video signal to create a linear representation between wave amplitudes and phases. \citep{holman2013} used a 2-dimenisional method with Kalman filtering to estimate the depth, $h$.
