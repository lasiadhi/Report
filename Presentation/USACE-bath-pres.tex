...
%==================================================================================
\begin{frame}
	\frametitle{1D forward model relates $H$ and $k$}
	Energy Flux Method:
...
%==================================================================================
\begin{frame}
 	\frametitle{Manufactured $k$ comes from forward model using real $h$}
		\begin{figure}[H]
	 		\centering
	 		\includegraphics[width=1.0\linewidth]{img/Flow_New.png}
	 	\end{figure}
...
%==================================================================================
\begin{frame}
	\frametitle{Results from manufactured test}
		\begin{figure}[H]
	 		\centering
	 		\includegraphics[width=0.2\linewidth]{img/MCMC-manufactured.eps}\\
			\includegraphics[width=0.5\linewidth]{img/nllsq_synthetic_1.eps}\\
			\includegraphics[width=0.5\linewidth]{img/fmincon_simulated_25m.png}
	 	\end{figure}
\end{frame}
...
%===================================================================================
\begin{frame}
	\frametitle{All bathymetry estimates reasonably locate sandbar}
		\begin{figure}[H]
	 		\centering
	 		\includegraphics[width=0.5\linewidth]{img/nllsq_real_1.eps}\\
			\includegraphics[width=0.5\linewidth]{img/nllsq_synthetic_1.eps}
	 	\end{figure}
\end{frame}
...
%===================================================================================
\begin{frame}
	\frametitle{[This one] gave the best bathymetry estimate}
\end{frame}
