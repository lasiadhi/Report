...
\column{0.5\textwidth}
\begin{figure}[h]
\includegraphics[width=.70\linewidth]{img/Top.jpg}\hfill
\end{figure}
...
\includegraphics[width=.75\linewidth]{img/flow_chart.jpg}\hfill
\end{figure}
...
I was thinking this should go here. What do you guys think?
...
\column{0.8\textwidth}
\begin{figure}[flowchart]
\includegraphics[width=.80\linewidth]{img/flow_chart.jpg}\hfill
\captionsetup{labelformat=empty}
